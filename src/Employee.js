...
class Employee extends Component {
  ...
  handleDelete(event) {
    ...
    axios.delete(`http://localhost:9005/employee/delete`, {
      data: {
      ...
      <Fragment>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <div class="form-group">
            <div class="col-md-8">
              <div class="row">
                <button id="delete_form" type="button" class="btn btn-secondary" onClick={this.handleSubmit.bind(this)}>Submit</button>
